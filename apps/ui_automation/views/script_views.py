...
class ScriptElementUsageViewSet(TenantAwareViewSetMixin, BaseProjectViewSet):
    queryset = ScriptElementUsage.objects.all()
    # ScriptElementUsage 无 project 直连字段，多跳到脚本所属项目的负责人
    org_field = 'script__project__owner'
    permission_classes = [IsAuthenticated]
    ...
    def analyze_script(self, request):
        ...
        try:
            ...
            script = self.scoped_get(TestScript, org_field='project__owner',
                id=script_id)
