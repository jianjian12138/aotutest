...
class TestCaseReviewViewSet(TenantAwareViewSetMixin, viewsets.ModelViewSet):
    permission_classes = [permissions.IsAuthenticated]
    org_field = 'projects__organization'
...
class TestCaseReviewCommentViewSet(TenantAwareViewSetMixin, viewsets.ModelViewSet):
    permission_classes = [permissions.IsAuthenticated]
    org_field = 'review__projects__organization'
...
class ReviewTemplateViewSet(TenantAwareViewSetMixin, viewsets.ModelViewSet):
    permission_classes = [permissions.IsAuthenticated]
    ...
    def get_queryset(self):
        ...
        return self._apply_tenant_scope(queryset.filter(is_active=True))
