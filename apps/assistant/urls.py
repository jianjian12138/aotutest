...
from .views import AssistantSessionViewSet, ChatViewSet, assistant_view, KnowledgeGraphViewSet, CrawlerViewSet, PredictiveQAViewSet, VisualRegressionViewSet
...
router.register(r'crawler', CrawlerViewSet, basename='autonomous-crawler')
router.register(r'predictive-qa', PredictiveQAViewSet, basename='predictive-qa')
router.register(r'visual-regression', VisualRegressionViewSet, basename='visual-regression')
