...
class TestReport(models.Model):
    ...
    api_test_execution = models.ForeignKey(ApiTestCaseExecution, on_delete=models.CASCADE, null=True, blank=True, related_name='reports', verbose_name='关联API测试执行')
    api_test_suite_execution = models.ForeignKey('api_testing.TestExecution', on_delete=models.CASCADE, null=True, blank=True, related_name='reports', verbose_name='关联API套件执行')
    ui_test_execution = models.ForeignKey('ui_automation.TestExecution', on_delete=models.CASCADE, null=True, blank=True, related_name='reports', verbose_name='关联UI测试执行')
