      ...
      <el-aside width="240px">
        ...
        >
          ...
          <template v-else-if="currentModule === 'natural-language-testing'">
            ...
            <el-divider />
            <el-menu-item index="/natural-language-testing/crawler-agent">
              <el-icon><Service /></el-icon>
              <span>自主探索 Agent</span>
            </el-menu-item>
            <el-menu-item index="/natural-language-testing/predictive-qa">
              <el-icon><Compass /></el-icon>
              <span>精准测试与风险预测</span>
            </el-menu-item>
            <el-menu-item index="/natural-language-testing/visual-regression">
              <el-icon><View /></el-icon>
              <span>多模态视觉回归</span>
            </el-menu-item>
            <el-menu-item index="/natural-language-testing/k8s-runner-status">
              <el-icon><Cpu /></el-icon>
              <span>云原生执行池</span>
            </el-menu-item>
          </template>
          ...
          <!-- 阶段1 企业基座：系统管理 -->
          <el-menu-item index="/system/defects">
            <el-icon><Warning /></el-icon>
            <span>缺陷管理</span>
          </el-menu-item>
          ...
          <el-menu-item index="/system/tenants">
...
import {
  ...
  Operation, Cellphone, Tools, Service, Files, Connection, Compass, View
...
const moduleName = computed(() => {
  const map = {
    ...
    'api-testing': '接口测试',
    'ui-automation': 'UI测试',
    'natural-language-testing': '智能化测试',
    'configuration': '配置中心',
    'data-factory': '数据工厂',
...
const breadcrumbTitle = computed(() => {
  const routeMap = {
    ...
    '/ai-generation/crawler-agent': '自主探索 Agent',
    '/ai-generation/predictive-qa': '精准测试与风险预测',
    '/ai-generation/visual-regression': '多模态视觉回归',
    '/ai-generation/k8s-runner-status': '云原生执行池',
    ...
    '/natural-language-testing/crawler-agent': '自主探索 Agent',
    '/natural-language-testing/predictive-qa': '精准测试与风险预测',
    '/natural-language-testing/visual-regression': '多模态视觉回归',
    '/natural-language-testing/k8s-runner-status': '云原生执行池',
