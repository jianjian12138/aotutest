  ...
  >
    <div v-if="currentConfig" class="view-dialog-content">
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="AI提供商">{{ currentConfig.provider }}</el-descriptions-item>
        <el-descriptions-item label="AI模型">{{ currentConfig.model }}</el-descriptions-item>
      ...
      <el-tabs v-model="activeTab" type="border-card">
        <el-tab-pane label="基本配置" name="basic">
          ...
          <el-form-item label="AI提供商" prop="provider">
            <el-select v-model="form.provider" placeholder="请选择AI提供商">
...
import { ElMessage, ElMessageBox, ElDialog, ElForm, ElFormItem, ElInput, ElSelect, ElOption, ElButton, ElSwitch, ElTabs, ElTabPane, ElText, ElDescriptions, ElDescriptionsItem } from 'element-plus'
import { Plus, Search, Edit, Delete, View, Check, Close, CircleCheck, CircleClose } from '@element-plus/icons-vue'
