    ...
    <div class="main-layout">
      ...
      <div class="sidebar">
        <div class="sidebar-header">
          ...
          <span class="header-title">测试数据助手</span>
        ...
        <div class="type-tabs">
          <div class="tab-item" :class="{ active: activeTab === 'text' }" @click="activeTab = 'text'">
            <el-icon><Document /></el-icon> 文本
          </div>
          <div class="tab-item" :class="{ active: activeTab === 'image' }" @click="activeTab = 'image'">
            <el-icon><Picture /></el-icon> 图片
          </div>
          <div class="tab-item" :class="{ active: activeTab === 'file' }" @click="activeTab = 'file'">
        ...
        <div class="sub-tabs">
           <span class="sub-tab" :class="{ active: activeSubTab === 'custom' }" @click="activeSubTab = 'custom'">自定义</span>
           <span class="sub-tab" :class="{ active: activeSubTab === 'url' }" @click="activeSubTab = 'url'">网址</span>
           <span class="sub-tab" :class="{ active: activeSubTab === 'case' }" @click="activeSubTab = 'case'">用例</span>
           <span class="sub-tab" :class="{ active: activeSubTab === 'record' }" @click="activeSubTab = 'record'">录制</span>
        </div>

        <div class="category-list">
           <!-- Custom Length Text -->
           <div class="custom-text-area" @click="addCustomField">
              <span class="bracket">[ ]</span> 自定义长度文本
           </div>

           <!-- Categories -->
           <div v-for="category in filteredCategories" :key="category.id" class="category-group">
             <div class="category-header" @click="toggleCategory(category)">
               <el-icon><User v-if="category.icon === 'user'" /></el-icon>
               <el-icon><Phone v-if="category.icon === 'phone'" /></el-icon>
               <el-icon><CreditCard v-if="category.icon === 'bank'" /></el-icon>
               <el-icon><Calendar v-if="category.icon === 'date'" /></el-icon>
               <span>{{ category.name }}</span>
               <el-icon class="arrow" :class="{ 'is-active': !category.collapsed }"><ArrowDown /></el-icon>
             </div>
             
             <div class="category-items" v-show="!category.collapsed">
               <div 
      ...
      <div class="main-content">
        <div class="page-header">
           ...
           <div class="actions">
             ...
             <el-button type="success" @click="exportData" :disabled="generatedData.length === 0">导出数据</el-button>
           </div>
        </div>
...
import { 
  ...
  User, Phone, CreditCard, Calendar, ArrowDown, Close
