      ...
      <el-row :gutter="20">
        <el-col :span="12">
          ...
          <el-form :model="taskForm" label-position="top">
            ...
            <!-- GIF生成参数配置 -->
            <el-form-item label="GIF生成参数" v-if="taskForm.enableGif">
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="帧率" prop="frameRate" label-width="60px">
                    <el-select v-model="taskForm.gifParams.frameRate" style="width: 100%">
                ...
                <el-col :span="12">
                  <el-form-item label="分辨率" prop="resolution" label-width="60px">
                    <el-select v-model="taskForm.gifParams.resolution" style="width: 100%">
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="质量" prop="quality" label-width="60px">
                    <el-slider v-model="taskForm.gifParams.quality" :min="1" :max="100" />
                    <div class="slider-value">{{ taskForm.gifParams.quality }}%</div>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="最大时长" prop="maxDuration" label-width="80px">
                    <el-input-number v-model="taskForm.gifParams.maxDuration" :min="1" :max="60" /> 秒
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form-item>
...
const handleRun = async () => {
  ...
  try {
      const response = await runAdhocAITask({
        ...
        gif_params: taskForm.gifParams  // 传递GIF生成参数
      })
