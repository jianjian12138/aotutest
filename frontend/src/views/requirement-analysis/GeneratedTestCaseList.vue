    ...
    <div v-if="selectedTestCaseDetail" class="testcase-detail-modal" @click="closeTestCaseDetail">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          ...
          <div class="detail-item">
            <label>测试步骤:</label>
            <div class="test-steps markdown-body" v-safe-html="formatMarkdown(selectedTestCaseDetail.test_steps)"></div>
          </div>
          <div class="detail-item">
            <label>预期结果:</label>
            <p v-safe-html="selectedTestCaseDetail.expected_result"></p>
          </div>
